...
void CxImage::SubImage(CxImage& imgsrc2, long lXOffset, long lYOffset, bool bAlpha)
{
    long lWide = imgsrc2.GetWidth();
    long lHeight = imgsrc2.GetHeight();

	bool bEditAlpha = imgsrc2.AlphaIsValid() & bAlpha;
    ...
    for(long lY=0;lY<lHeight;lY++)
    {
        ...
        {
#if CXIMAGE_SUPPORT_SELECTION
			if (SelectionIsInside(lX+lXOffset,lY+lYOffset) && imgsrc2.SelectionIsInside(lX,lY))
#endif //CXIMAGE_SUPPORT_SELECTION
			{
				rgb2 = imgsrc2.GetPixelColor(lX,lY);

				SetPixelColor(lX+lXOffset,lY+lYOffset,rgb2,bEditAlpha);
			}
		}
	}
}
...
#endif //CXIMAGE_SUPPORT_SELECTION
			{
				...
				switch(op)
				{
					...
					case OpSrcBlend:
						...
						break;
					case OpCpy:
						rgbDest.rgbBlue = (BYTE)rgb2.rgbBlue;
						rgbDest.rgbGreen = (BYTE)rgb2.rgbGreen;
						rgbDest.rgbRed = (BYTE)rgb2.rgbRed;
						if (bEditAlpha) rgbDest.rgbReserved = (BYTE)rgb2.rgbReserved;
