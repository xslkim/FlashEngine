...
/** \addtogroup Constructors */ //@{
	...
	CxImage(const char * filename, DWORD imagetype);	// For UNICODE support: char -> TCHAR
...
/** \addtogroup Initialization */ //@{
	...
	bool	Create(void* pData, long width, long height, COLORREF color,DWORD dwFormat);

	//bool	SplitPowerOf2(LPCTSTR szPrefix, LPCTSTR szSubfix);
	// added end 
...
/** \addtogroup Painting */ //@{
	...
	// added by liudx
	//bool	Create(HDC hdc, const TCHAR* text, int len, HFONT hFont, COLORREF cText, COLORREF cBack, bool bSetAlpha=false, int nDisplayWidth = 0);
	// end
...
/** \addtogroup DSP */ //@{
	...
	void SubImage(CxImage& imgsrc2, long lXOffset, long lYOffset, bool bAlpha);
	enum ImageOpType { OpAdd, OpAnd, OpXor, OpOr, OpMask, OpSrcCopy, OpDstCopy, OpSub, OpSrcBlend, OpScreen, OpAvg, OpCpy };
...
protected:
	...
	static inline long NextPowerOf2(long v)
	{
		v--;
		v |= v >> 1;
		v |= v >> 2;
	...
	static inline long PrevPowerOf2(long v)
	{
