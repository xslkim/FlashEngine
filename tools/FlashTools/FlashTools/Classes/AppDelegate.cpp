...
bool AppDelegate::initInstance() {
	...
	do {
		...
		int screenWidth = getDataLogicMgr()->getScreenWidth();

		CC_BREAK_IF(! pMainWnd	|| ! pMainWnd->Create(TEXT("cocos2d: Hello World"), screenWidth, screenHeight));
