...
const FlashMetaMatrixEx& FlashMetaMatrixEx::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_flashMetaEx_2eproto();  return *default_instance_;
}
      ...
      case 25: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_bitMapNames:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->bitmapnames(0).data(), this->bitmapnames(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 60: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_namePool:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->namepool(0).data(), this->namepool(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
