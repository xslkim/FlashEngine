...
class BoxActionInfo : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_trans(::BoxTrans* trans);
...
inline void BoxActionInfo::set_allocated_actionname(::std::string* actionname) {
  if (actionname_ != &::google::protobuf::internal::kEmptyString) {
    delete actionname_;
  }
  if (actionname) {
...
inline void BoxActionInfo::set_allocated_trans(::BoxTrans* trans) {
  delete trans_;
  trans_ = trans;
  if (trans) {
    set_has_trans();
...
inline void BoxFlashInfo::set_allocated_spritename(::std::string* spritename) {
  if (spritename_ != &::google::protobuf::internal::kEmptyString) {
    delete spritename_;
  }
  if (spritename) {
