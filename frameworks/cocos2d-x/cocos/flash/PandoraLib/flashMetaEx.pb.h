...
class FlashMetaDataEx : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_tempmatrix(::FlashMetaMatrixEx* tempmatrix);
...
inline void FlashMetaDataEx::set_allocated_tempmatrix(::FlashMetaMatrixEx* tempmatrix) {
  delete tempmatrix_;
  tempmatrix_ = tempmatrix;
  if (tempmatrix) {
    set_has_tempmatrix();
  } else {
    clear_has_tempmatrix();
...
inline void FlashMetaSymbolEx::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
...
inline void FlashMetaEx::set_allocated_spritename(::std::string* spritename) {
  if (spritename_ != &::google::protobuf::internal::kEmptyString) {
    delete spritename_;
  }
  if (spritename) {
