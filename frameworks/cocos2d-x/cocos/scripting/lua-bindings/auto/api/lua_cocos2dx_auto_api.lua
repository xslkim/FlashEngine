...
--------------------------------------------------------
-- the cc MeshSprite
-- @field [parent=#cc] MeshSprite#MeshSprite MeshSprite preloaded module


--------------------------------------------------------
-- the cc PvpManager
-- @field [parent=#cc] PvpManager#PvpManager PvpManager preloaded module


--------------------------------------------------------
-- the cc FlashSprite
-- @field [parent=#cc] FlashSprite#FlashSprite FlashSprite preloaded module


--------------------------------------------------------
-- the cc BoxFlash
-- @field [parent=#cc] BoxFlash#BoxFlash BoxFlash preloaded module


--------------------------------------------------------
-- the cc DynamicUpdateMgr
-- @field [parent=#cc] DynamicUpdateMgr#DynamicUpdateMgr DynamicUpdateMgr preloaded module


--------------------------------------------------------
-- the cc RandomMgr
-- @field [parent=#cc] RandomMgr#RandomMgr RandomMgr preloaded module
...
--------------------------------------------------------
-- the cc PlistResMgr
-- @field [parent=#cc] PlistResMgr#PlistResMgr PlistResMgr preloaded module


--------------------------------------------------------
-- the cc FlashCacheMgr
-- @field [parent=#cc] FlashCacheMgr#FlashCacheMgr FlashCacheMgr preloaded module


--------------------------------------------------------
-- the cc AesZipUtils
-- @field [parent=#cc] AesZipUtils#AesZipUtils AesZipUtils preloaded module
