...
--------------------------------
-- @function [parent=#Director] setXXTEAKeyAndSign 
-- @param self
-- @param #string str
-- @param #string str
...
--------------------------------
-- @function [parent=#Director] setIsFixedFrameTime 
-- @param self
-- @param #bool bool
...
--------------------------------
-- @function [parent=#Director] getXXTEASign 
-- @param self
...
--------------------------------
-- @function [parent=#Director] getXXTEAKey 
-- @param self
-- @return string#string ret (return value: string)
